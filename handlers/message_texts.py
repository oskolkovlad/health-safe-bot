...
REMINDER_REMOVED_TEXT = (
    "❌🔔 Повторное напоминание\nдля лекарства <b>«{med_name}»</b>, назначенное\nна {run_at}, было удалено!\n"
    "Это произошло в связи с тем, что срок его действия истек (более 5 часов)...\n\n"
    "Вероятная причина - неполадки с сетью 💻🔌"
)
